...
10.2.2	Static and Reference data
...
Change history of static and reference data is stored [describe how]
10.2.3	Data lineage
...
10.5.2	Data breach and reporting process
...
10.5.3	Privacy incident, data complaint and subject data request handling
...
11	Database Provisioning and Deployment
This chapter describe any special steps to provision or install the RDBMS, and specific configuration that is required on the RDBMS and what data is required to prime the database before the application can be opened for production use. 
11.1	Provisioning of the RDBMS
[Describe how the RDBMSs would be provisioned if they were cloud-based, or how they would be installed on a server if they were on premise-based.]
11.2	Data initialization
[Initial data may consist of initial users, initial roles, reference tables of e.g. currencies, countries, NATO abbreviations, and other pertinent reference data.]

 
Appendix A 	Entity-Relationship Data Model
[Include an overview of the data model for each of the application’s databases]
 
Appendix B 	Application-level Data Error Codes
This appendix lists the application-specific error codes that can arise from data-specific error conditions.

Error Code	Message	Explanation / Remedy
